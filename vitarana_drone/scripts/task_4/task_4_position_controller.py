...
class Edrone():
    ...
    def __init__(self):
        ...
        filepath = rospack.get_path('vitarana_drone')+'/scripts/task_4/manifest.csv'
...
def main():
    ...
    for i in range(len(e_drone.buildings)):
        rospy.loginfo("BOSS, initializing delivery no. " + str(box_id))
        ...
        if(box_id == 1):
            ...
            reach_destination(height_corection=6, hc=1, position=False, speed=100)
        ...
        gripper_active(1)
        rospy.loginfo("parcel no. " + str(box_id) + " picked up and ready for delivery!!")
        ...
        rospy.loginfo("Reached Building no." + str(e_drone.current_marker_id) + 'BOSS')
        ...
        rospy.loginfo("landing marker detected Captain")
        ...
        gripper_active(0)
        rospy.loginfo("Reached marker " + str(e_drone.current_marker_id) + " parcel delivered BOSS!!!")
